...
public class HomeController {
    ...
    @Autowired
    public HomeController(QuestionService questionService, UserService userService, FollowService followService, CommentService commentService, HostHolder hostHolder) {
